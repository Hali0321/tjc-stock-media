...
Preserve HEIC originals as master files. When ResourceSpace cannot preview a HEIC, attach a metadata-stripped JPG derivative to the same ResourceSpace asset and promote that JPG derivative into the front thumbnail/preview slots.

## User Behavior

- Normal users see the JPG preview first and use/download the metadata-stripped JPG derivative for common communications work.
...
- copies derivative preview sizes into the main thumbnail/preview slots
