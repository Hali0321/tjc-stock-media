...
export function EnterprisePackageBuilderPage() {
  ...
  const saveDraft = async () => {
    ...
    try {
      ...
      setPackageMessage(`Draft saved to ${payload.storageMode || "local-json"} with ${payload.package?.governance?.totalRefs ?? governance.totalRefs} ResourceSpace refs.`);
    } catch (error) {
