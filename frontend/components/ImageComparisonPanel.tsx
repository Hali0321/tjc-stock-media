    ...
    <section className="rounded-md border border-[#d4ded7] bg-white p-3" aria-label="Derivative comparison">
      <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
        <div>
          ...
          <p className="mt-1 text-xs font-semibold leading-snug text-tjc-muted">Compares role-safe display copy against approved-copy availability. Source files are never exposed here.</p>
        </div>
