      ...
      <section className="detail-layout">
        ...
        <aside className="detail-panel">
          ...
          <div className="safe-answer">
            ...
            <div>
              <strong>{canDownload ? "Approved copy available." : "Not approved for use."}</strong>
          ...
          <div className="download-panel download-panel--approved">
            <div>
              <h2>Approved copy</h2>
              <p>Use this for normal ministry download when status allows.</p>
            </div>
            {canDownload ? (
          ...
          <section className="notes-panel">
            <h2>Rights notes</h2>
            <p>{asset.rightsNotes || "No reviewer notes exported yet."}</p>
          </section>
