...
1. Start on Library.
2. Search `Bible`.
3. Show the compact command search, use-case shortcuts, clear result count, saved DAM views, filters, sort controls, contact-sheet results, and collection entry points.
4. Open one asset.
